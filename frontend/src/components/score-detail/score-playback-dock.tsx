...
type ScorePlaybackDockProps = Omit<ScorePreviewControlsProps, 'compact'>;

export function ScorePlaybackDock(controls: ScorePlaybackDockProps) {
  return (
    <div
      data-testid="score-playback-dock"
