...
For the full operator runbook, see `docs/operations/observability/grafana-loki-query-runbook.md`.
...
4. Introduce OpenTelemetry and Tempo after trace sampling and retention policy
   are decided. See `docs/operations/observability/opentelemetry-tempo-tracing-plan.md`.
