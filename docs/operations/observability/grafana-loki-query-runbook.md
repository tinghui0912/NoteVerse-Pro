...
See `docs/operations/observability/k8s-logging-loki-fluent-bit-plan.md` for deployment shape and label
policy.
...
Tracing design is documented in `docs/operations/observability/opentelemetry-tempo-tracing-plan.md`.
