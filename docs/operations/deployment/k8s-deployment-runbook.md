...
kubectl -n noteverse-production rollout status deployment/noteverse-customer-web
```
...
```bash
kubectl -n noteverse-production port-forward svc/noteverse-customer-web 3000:3000
