...
```text
apps/customer-web/src/app/[locale]/score/[id]/
  page.tsx
  edit/
    page.tsx
    loading.tsx
...
apps/customer-web/src/app/[locale]/review/[jobId]/
  page.tsx
  edit/
    page.tsx

apps/customer-web/src/components/score-shell/
  score-shell.tsx

apps/customer-web/src/components/score-detail/
  current score detail components

apps/customer-web/src/components/editor/
  editor workspace components

apps/customer-web/src/components/practice/
...
```text
apps/customer-web/src/app/[locale]/review/[id]/page.tsx
```
...
```text
apps/customer-web/src/app/[locale]/editor/[id]/page.tsx
```

to:

```text
apps/customer-web/src/app/[locale]/score/[id]/edit/page.tsx
```
...
```text
apps/customer-web/src/app/[locale]/practice/[id]/page.tsx
apps/customer-web/src/app/[locale]/practice/[id]/performance/page.tsx
```

to:

```text
apps/customer-web/src/app/[locale]/score/[id]/practice/page.tsx
apps/customer-web/src/app/[locale]/score/[id]/practice/performance/page.tsx
```
...
- `apps/customer-web/src/components/score-detail/score-actions.tsx`
- `apps/customer-web/src/components/share/share-info-sidebar.tsx`
- `apps/customer-web/src/app/[locale]/review/[id]/page.tsx`
- tests
...
```text
apps/customer-web/src/app/[locale]/editor
apps/customer-web/src/app/[locale]/practice
```
...
- Created `apps/customer-web/src/components/score-shell/score-shell.tsx`.
...
- Updated `apps/customer-web/src/proxy.ts` so `/score` is the protected Score route family.
...
- Added `apps/customer-web/src/lib/score-shell/capabilities.ts`.
...
- Added `apps/customer-web/src/components/score-shell/workspace-access-denied.tsx`.
...
- Removed the unused legacy `apps/customer-web/src/components/share/share-actions.tsx`.
...
- Updated `docs/archive/completed-migrations/library-domain-implementation-plan.md` current return-origin examples from `/results/:id` to `/score/:id`.
...
- Added `apps/customer-web/tests/unit/score-workspace-routes.test.ts`.
...
- Removed `/review` from `apps/customer-web/src/proxy.ts` because `/score` protects the workspace family.
...
- Removed unused legacy `apps/customer-web/src/contexts/share-context.tsx`.
- Removed obsolete `tasks`, `xml`, and legacy `shares` query key factories from `apps/customer-web/src/lib/query-client.ts`.
